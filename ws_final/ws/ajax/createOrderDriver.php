<?php
	...
	$insert_order = mysqli_prepare($connect,"insert into table_order(user_id,order_user_id,order_info_id,comment,type_order) values(?,?,?,?,?);");
	mysqli_stmt_bind_param($insert_order,'iiisi',$id_user,$id_user_info,$id_info,$comment,$type);
